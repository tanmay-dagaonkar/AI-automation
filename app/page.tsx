...
const statusLabel: Record<PublicApplication["status"], string> = { pending_approval: "Waiting for approval", processing: "Analyzing", completed: "Ready", analysis_failed: "Needs attention", rejected: "Not approved" };
